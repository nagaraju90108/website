        ...
        >
          ...
          <nav className="navBarDesktop">
            <ul className="navBarList ">
              ...
              <li className="">
                <NavLink
                  activeStyle={{ color: "white", background: "transparent" }}
                  to={LoginStatus === "0" ? "/signin" : "/myprofile"}
                  className="bg-mycolor px-5 py-1 border-2 border-mycolor rounded-full hover:bg-transparent hover:text-mycolor"
                >
              ...
              <div className="mt-7 px-3 ">
                <div className="">
                  ...
                  >
                    ...
                    <p className="menuBarRowCells">Academics</p>
                  </NavLink>
                  <NavLink
                    to="/campus"
                    exact={true}
                  ...
                  >
                    ...
                    <p className="menuBarRowCells">Campus</p>
                  </NavLink>
                  <NavLink
                    to="/about"
                    activeStyle={{ backgroundColor: "#ff730065" }}
